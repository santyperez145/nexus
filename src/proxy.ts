...
export function proxy(request: NextRequest) {
  ...
  if (
    ...
    !request.nextUrl.pathname.startsWith("/api/internal/cron/") &&
    shouldRejectCredentialedMutation(request, APP_URL)
  ) {
  ...
  const cors =
    mode === "public"
      ...
      : credentialCorsHeaders(request, APP_URL);
