    ...
    <MarketingShell>
      <div className="mx-auto max-w-3xl px-4 py-12 md:py-16">
        ...
        <ul className="mb-8 list-disc space-y-2 pl-5 text-sm text-zinc-600">
          ...
          <li>Files: 8 MB vía formulario o hasta 50 GiB vía upload directo S3-compatible; desde 100 MiB usa partes reintentables con SHA-256.</li>
          <li>
...
# o vía dashboard Overview → card Rate limits`}
        ...
        <div className="overflow-hidden rounded-xl border border-zinc-200 bg-white text-sm">
          {[
            ...
            ["Files", "1/25/250 GiB por plan · SHA-256 · 50 GiB por upload multipart"],
